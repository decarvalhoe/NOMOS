...
| [52 - Development resumption plan (2026-09-11)](52-plan-de-reprise-2026-09.md) | Where the tree stands after the beta (baseline replayed on a fresh machine, what the inventory found: stale README counts, a diverged forge mirror, `gh` coupling in the sidecars), the directions retained (sovereign forge as reference, ADR-0006), four waves — tooling and baseline (done), forge reconciliation (PR open), forge neutrality FN-1..FN-4 (#737, #736, #738, #739), hygiene — and what stays human. `active plan` |
