...
| [48 - Neighbouring sovereign legal RAG: concepts, anti-patterns, collaboration](48-sovereign-legal-rag-concepts-and-collaboration.md) | What NOMOS integrates from a neighbouring sovereign legal RAG reviewed from two private dated documents: domain cartography contract, parameter inventory template, inference boundary; the silent-failure anti-patterns encoded as doctrine principle 8; the collaboration brief (verification-first checklist, questions, interfaces, red lines). No third-party figure or finding is reproduced. `analysis + plan` |
