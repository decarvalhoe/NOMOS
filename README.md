...
- `docs/28-regulated-compliance-closure-plan.md` : plan courant pour fermer les gaps compliance, GitHub QMS, bibles licenciées, validation et release evidence.
...
- `docs/28-regulated-compliance-closure-plan.md` est le plan d'execution courant pour passer de main techniquement vert a une posture compliance defendable.
