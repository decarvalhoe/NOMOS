...
|---|---|---|
| Matrice de câblage (VRC-00) | 66 capacités, 0 écart entre registre et arbre, 0 commande fantôme | `scripts/vrc_wiring_matrix.py` ; le fichier généré est comparé au commit |
